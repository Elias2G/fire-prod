    ...
    <div className="row">
      <div className="column col-s-12 nop placeholder_img">
        ...
        <div className="text-pos">
          {!props.loaded ? <h3 className="exo primary-light card-image-title">.</h3> : <h3 className="primary-light card-image-title">{props.data.Bezeichnung}</h3>}
      ...
      <div className="column col-s-7">
        {!props.loaded ? <p className="exo">.</p> : <p>{props.data.Beschreibung}</p>}
